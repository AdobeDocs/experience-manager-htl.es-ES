...
Traduce la cadena al idioma del *origen* actual (consulte más abajo), utilizando el [diccionario](https://docs.adobe.com/content/help/es/experience-manager-65/developing/components/internationalization/i18n-translator.html) actual. Si no se encuentra ninguna traducción, se utiliza la cadena original.
