...
Aunque hay varias formas de incorporar una clase Java con HTL, la más sencilla es ampliar la variable `WCMUsePojo` clase. Para nuestro ejemplo `/apps/my-example/component/info/Info.java`:
