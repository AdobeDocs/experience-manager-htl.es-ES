...
Aunque hay varias formas de incorporar una clase Java con HTL, la más sencilla es ampliar la clase `WCMUsePojo`: Para nuestro ejemplo `/apps/my-example/component/info/Info.java`:
